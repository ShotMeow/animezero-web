...
const PrivacyPolicyScreen: FC = () => {
  return (
    <main className="container my-16 md:my-32">
      <TitleBlock className="mb-10" breadcrumbs="Политика конфиденциальности">
        <h1 className="break-words text-4xl">Политика конфиденциальности</h1>
        <p className="font-light text-zinc-400">
          Мы уверяем вас, что данные, оставленные на нашем сайте не будут
          подвергаться <br /> распространению.
        </p>
      </TitleBlock>
      <ol className="ml-4 list-decimal space-y-4 text-sm [&>li>figure>figcaption]:text-xl [&>li>figure>figcaption]:font-bold">
        <li>
          <figure className="space-y-2">
            <figcaption>Общие положения</figcaption>
            <p>
              Настоящая политика обработки персональных данных составлена в
              соответствии с требованиями Федерального закона от 27.07.2006.
              №152-ФЗ «О персональных данных» (далее -{" "}
              <b>Закон о персональных данных</b>) и определяет порядок обработки
              персональных данных и меры по обеспечению безопасности
              персональных данных, предпринимаемые ООО «AnimeZero» (далее –{" "}
              <b>Оператор</b>).
            </p>
        ...
        <li>
          <figure className="space-y-2">
            <figcaption>Основные понятия, используемые в Политике</figcaption>
            <ol className="ml-8 list-decimal space-y-2">
              <li>
        ...
        <li>
          <figure className="space-y-2">
            <figcaption>Основные права и обязанности Оператора</figcaption>
            <ol className="ml-8 list-decimal space-y-2">
              <li>
                <figure>
                  <figcaption>Оператор имеет право:</figcaption>
              ...
              <li>
                <figure>
                  <figcaption>Оператор обязан:</figcaption>
                  <ul className="ml-8 list-disc">
                    <li>
        ...
        <li>
          <figure className="space-y-2">
            ...
            <ol className="ml-8 list-decimal space-y-2">
              ...
              <li>
                <figure>
                  <figcaption>Субъекты персональных данных обязаны:</figcaption>
                  <ul className="ml-8 list-disc">
        ...
        <li>
          <figure className="space-y-2">
            ...
            <ol className="ml-8 list-decimal space-y-2">
              ...
              <li>
                Обработка персональных данных, разрешенных для распространения,
                из числа специальных категорий персональных данных, указанных в
                ч. 1 ст. 10 Закона о персональных данных, допускается, если
                соблюдаются запреты и условия, предусмотренные ст. 10.1 Закона о
                персональных данных.
              </li>
              <li>
              ...
              <li>
                ...
                получения указанного согласия Пользователя опубликовать
              ...
              <li>
                ...
                Оператору требования, указанного в настоящей Политики в
        ...
        <li>
          <figure className="space-y-2">
            <figcaption>Принципы обработки персональных данных</figcaption>
            <ol className="ml-8 list-decimal space-y-2">
              <li>
        ...
        <li>
          <figure className="space-y-2">
            <figcaption>Цели обработки персональных данных</figcaption>
            <ol className="ml-8 list-decimal space-y-2">
              <li>
                <figure>
                  <figcaption>
              ...
              <li>
                ...
                электронной почты admin@animezero.ru с пометкой «Отказ от
        ...
        <li>
          <figure className="space-y-2">
            <figcaption>Условия обработки персональных данных</figcaption>
            <ol className="ml-8 list-decimal space-y-2">
              <li>
              ...
              <li>
                ...
                законом, для осуществления возложенных законодательством
          ...
          <figure className="space-y-2">
            ...
            <ol className="ml-8 list-decimal space-y-2">
              ...
              <li>
                ...
                случае, если субъектом персональных данных дано согласие
              ...
              <li>
                ...
                <Link
                  className="font-semibold text-purple"
                  href="mailto:support@animezero.ru"
                >
              ...
              <li>
                ...
                числе платежными системами, средствами связи и другими
        ...
        <li>
          <figure className="space-y-2">
            <figcaption>Трансграничная передача персональных данных</figcaption>
            <ol className="ml-8 list-decimal space-y-2">
              <li>
        ...
        <li>
          <figure className="space-y-2">
            <figcaption>Конфиденциальность персональных данных</figcaption>
            <p>
        ...
        <li>
          <figure className="space-y-2">
            <figcaption>Заключительные положения</figcaption>
            <ol className="ml-8 list-decimal space-y-2">
              <li>
              ...
              <li>
                ...
                <Link
                  ...
                  href="https://animezero.ru"
                >
                  https://animezero.ru/privacy-policy
                </Link>
                .
              </li>
            </ol>
